...
function App() {
  ...
  return (
    ...
    <p>Streamline your workflow and elevate your productivity with the transformative power of AI automation. Create compelling UX/UI case studies effortlessly and focus on what truly matters.</p>
    <p>Sign up and be the first to be notified when we open our doors</p>
